      ...
      {!isShow && (
        <>
          <ResultImageContainer>
            ...
            <GameImage src={newArray[0].imgUrl} alt="your choice" />
          </ResultImageContainer>
          <ResultImageContainer>
            <ResultName>OPPONENT</ResultName>
            <GameImage src={newArray[1].imgUrl} alt="opponent choice" />
          </ResultImageContainer>
          <ResultImageContainer>
